...
| :--- | :---: | :--- |
| **[EduTech - Plataforma](LINK_DO_REPO)** | ![Python](https://img.shields.io/badge/-Python-333?style=flat&logo=python) ![Postgres](https://img.shields.io/badge/-Postgres-333?style=flat&logo=postgresql) | **Back-end Complexo.** Arquitetura de banco de dados (3FN), uso de ENUMs e Data Pipeline para geração de dados massivos. |
| **[Extrator de PDF](LINK_DO_REPO)** | ![Python](https://img.shields.io/badge/-Python-333?style=flat&logo=python) ![Streamlit](https://img.shields.io/badge/-Streamlit-333?style=flat&logo=streamlit) | **Automação Real.** Script que automatizou o parsing de centenas de PDFs de importação para Excel. |
| **[Análise Netflix](LINK_DO_REPO)** | ![Python](https://img.shields.io/badge/-Python-333?style=flat&logo=python) ![Data](https://img.shields.io/badge/-Data-333?style=flat) | **Data Science.** Clusterização de gêneros e dashboards interativos. Unindo minha base científica com tech. |
...
<div align="center">
  <table>
    <tr>
      ...
      <td>
        <img src="https://media1.tenor.com/m/FZx3TFExGOIAAAAd/gon-smile.gif" alt="Gon" width="120"/>
      </td>
    </tr>
  </table>
</div>
